...
def init_dishes_pant(restaurant)
  dish = Dish.create!(
    ...
    health_labels =["Mediterranean", "Pescatarian", "Vegan", "Vegetarian",
                    "Alcohol-Free", "Dairy-Free", "Egg-Free", "Fish-Free",
                    "Peanut-Free", "Pork-Free", "Poultry-Free", "Red-Meat-Free",
                    "Sesame-Free", "Shellfish-Free", "Soy-Free","Tree-Nut-Free"]
